...
printf '%s\n' "$BADGING" | sed -n '1,8p'
printf '%s\n' "$BADGING" | grep -Fq "package: name='br.com.quickprint.os' versionCode='12' versionName='2.0.0'"
...
NOTES="${QP_RELEASE_NOTES:-Quick Print OS 2.0.0 — Autonomous Print Studio: Quick Drop, Quick Proof, Magic Preflight, Smart Sheet, recomendação explicável de impressoras e Pedido Inteligente com IA local opcional, usando migração Room 7→8 não destrutiva.}"
...
<title>Quick Print OS 2.0.0</title>
<style>
